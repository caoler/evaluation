...
import cn.caoler.evaluation.converter.ActionRole2ActionRoleDTOConverter;
...
import cn.caoler.evaluation.repository.ActionRoleRepository;
import cn.caoler.evaluation.repository.RoleRepository;
...
import static cn.caoler.evaluation.converter.ActionRole2ActionRoleDTOConverter.convert;

/**
 *  角色权限
 * Created by caole on 2019/4/3 16:53
 */
@Service
@Transactional
public class ActionRoleServiceImpl implements ActionRoleService {
    ...
    public Page<ActionRoleDTO> findRoleActionIfRoleNameIsNotNull(String roleName, Pageable pageable) {
        ...
        List<ActionRoleDTO> actionRoleDTOList = ActionRole2ActionRoleDTOConverter.convert(actionRolePage.getContent());
    ...
    public ActionRoleDTO findByActionRoleId(Long actionRoleId) {
        ...
        ActionRoleDTO actionRoleDTO = ActionRole2ActionRoleDTOConverter.convert(actionRole);
        List<ActionRole> actionRoleList = actionRoleRepository.findActionRolesByRoleId(actionRoleDTO.getRoleId());
